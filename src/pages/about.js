  ...
  return (
    <Layout>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          I am currently working as a Scrum Master and Software Engineer on several
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          general. In the past I also had a prominent role as a UX/UI
          ...
          powerlifting. And whenever I can, I go into the water to surf.
        </p>
